...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectiveSound.Core.Permissions.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CollectiveSound.Core.Roles.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "27dc80f1-0c5c-4acd-9393-78c955fc6a53",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e74a9775-eb21-48b3-bc4c-b9f9505c1a31",
                            IsSystemDefault = true,
                            Name = "Member",
            ...
            modelBuilder.Entity("CollectiveSound.Core.Roles.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectiveSound.Core.Roles.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CollectiveSound.Core.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 5,
                            ConcurrencyStamp = "e2e7a048-0de0-4412-8bee-e9181f6da13e",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 5,
                            ConcurrencyStamp = "576054bb-887d-4b51-867f-aeb25f9f0370",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 5,
                            ConcurrencyStamp = "5db5106c-12f4-484b-a450-7dfb5381fab4",
            ...
            modelBuilder.Entity("CollectiveSound.Core.Users.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectiveSound.Core.Users.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("CollectiveSound.Core.Users.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CollectiveSound.Core.Users.UserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CollectiveSound.Core.Roles.RoleClaim", b =>
                {
                    b.HasOne("CollectiveSound.Core.Roles.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CollectiveSound.Core.Roles.RolePermission", b =>
                {
                    b.HasOne("CollectiveSound.Core.Permissions.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CollectiveSound.Core.Roles.Role", "Role")
                        .WithMany("RolePermissions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CollectiveSound.Core.Users.UserClaim", b =>
                {
                    b.HasOne("CollectiveSound.Core.Users.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CollectiveSound.Core.Users.UserRole", b =>
                {
                    ...
                    b.HasOne("CollectiveSound.Core.Users.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
